...
dataframeforRTP = data.frame("Contracttype" = "RTP", "Step" = myDataAnalysis$step, "Number_of_Consumers" = myDataAnalysis$total_consumers_RTP, "Marketshare" = myDataAnalysis$marketshare_RTP, "Runnumber" = myDataAnalysis$run_number, "Infostrategy" = myDataAnalysis$info_RTP, "infostrategy_increasevalue" = myDataAnalysis$infostrategy_increasevalue, "percentage_unresponsive_consumers" = myDataAnalysis$percentage_unresponsive_consumers)
dataframeforCPP = data.frame("Contracttype" = "CPP", "Step" = myDataAnalysis$step, "Number_of_Consumers" = myDataAnalysis$total_consumers_CPP, "Marketshare" = myDataAnalysis$marketshare_CPP, "Runnumber" = myDataAnalysis$run_number, "Infostrategy" = myDataAnalysis$info_CPP, "infostrategy_increasevalue" = myDataAnalysis$infostrategy_increasevalue, "percentage_unresponsive_consumers" = myDataAnalysis$percentage_unresponsive_consumers)
dataframeforToU = data.frame("Contracttype" = "ToU", "Step" = myDataAnalysis$step, "Number_of_Consumers" = myDataAnalysis$total_consumers_ToU, "Marketshare" = myDataAnalysis$marketshare_ToU, "Runnumber" = myDataAnalysis$run_number, "Infostrategy" = myDataAnalysis$info_ToU, "infostrategy_increasevalue" = myDataAnalysis$infostrategy_increasevalue, "percentage_unresponsive_consumers" = myDataAnalysis$percentage_unresponsive_consumers)
dataframeforRTPH = data.frame("Contracttype" = "RTPH", "Step" = myDataAnalysis$step, "Number_of_Consumers" = myDataAnalysis$total_consumers_RTPH, "Marketshare" = myDataAnalysis$marketshare_RTPH, "Runnumber" = myDataAnalysis$run_number, "Infostrategy" = myDataAnalysis$info_RTPH, "infostrategy_increasevalue" = myDataAnalysis$infostrategy_increasevalue, "percentage_unresponsive_consumers" = myDataAnalysis$percentage_unresponsive_consumers) 
