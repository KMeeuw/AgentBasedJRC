...
to setup-turtles
  ...
  ask turtles [ set contractvalues array:from-list [0 TRUE 0 FALSE 0 FALSE 0 FALSE ] ]
...
to setup-contracts
  set RTP array:from-list [2 0.8 0.4 0.6 0.2 0.2]
  set CPP array:from-list [3 0.4 0.6 0.2 0.4 0.8]
  set ToU array:from-list [4 0.2 0.6 0.4 0.2 0.8]
  set RTPH array:from-list [1 0.8 0.2 0.8 0 0.8]
end

to calculateconsumercontracts
;  let test array:item RTPH 1 * array:item RTPH 2
  ask turtles[
...
;    let test [contA contB contC contD]
;    let highest max test
;    ifelse(array:item contractvalues 0 = highest)[
;      array:set contractvalues 1 = TRUE and array:set contractvalues 3 = FALSE and array:set contractvalues 5 = FALSE and array:set contractvalues 7 = FALSE]
;      [ifelse(array:item contractvalues 2 = highest)[
;        array:set contractvalues 1 = FALSE and array:set contractvalues 3 = TRUE and array:set contractvalues 5 = FALSE and array:set contractvalues 7 = FALSE]
;        [ifelse(array:item contractvalues 4 = highest)[
;          array:set contractvalues 1 = FALSE and array:set contractvalues 3 = FALSE and array:set contractvalues 5 = TRUE and array:set contractvalues 7 = FALSE]
;          [ifelse(array:item contractvalues 6 = highest)[
;            array:set contractvalues 1 = FALSE and array:set contractvalues 3 = FALSE and array:set contractvalues 5 = FALSE and array:set contractvalues 7 = TRUE]
